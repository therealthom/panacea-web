    ...
    <s2ui:tab name='userinfo' height='275'>
      <table>
        ...
        <s2ui:passwordFieldRow name='password' labelCode='user.password.label' bean="${user}"
                               labelCodeDefault='Contraseña' value="${user?.password}"/>
        ...
        <s2ui:checkboxRow name='accountLocked' labelCode='user.accountLocked.label' bean="${user}"
                          labelCodeDefault='Cuenta bloqueda' value="${user?.accountLocked}"/>

        <s2ui:checkboxRow name='passwordExpired' labelCode='user.passwordExpired.label' bean="${user}"
                          labelCodeDefault='Contraseña expirada' value="${user?.passwordExpired}"/>
        </tbody>
      </table>
    </s2ui:tab>
