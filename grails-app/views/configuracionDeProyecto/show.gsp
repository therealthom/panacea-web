  ...
  <div class="container-fluid">
    ...
    <div class="well">
				...
				<g:if test="${configuracionDeProyectoInstance?.repositorioExistente}">
						...
						<dd><g:link controller="repositorio" action="show" id="${configuracionDeProyectoInstance?.repositorioExistente?.id}">${configuracionDeProyectoInstance?.repositorioExistente?.encodeAsHTML()}</g:link></dd>
