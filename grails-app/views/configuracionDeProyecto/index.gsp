                ...
                <table class="table table-striped table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="nuevoRepositorio" title="${message(code: 'configuracionDeProyecto.nuevoRepositorio.label', default: 'Nuevo Repositorio')}" />

                            <g:sortableColumn property="repositorioExistente" title="${message(code: 'configuracionDeProyecto.repositorioExistente.label', default: 'Repositorio Existente')}" />
                    ...
                    <tbody>
                        <g:each in="${configuracionDeProyectoInstanceList}" status="i" var="configuracionDeProyectoInstance">
                            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                ...
                                <td>${fieldValue(bean: configuracionDeProyectoInstance, field: "nuevoRepositorio")}</td>
